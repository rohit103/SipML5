...
SIPml.Stack = function (o_conf) {
    ...
    */
    ...
    this.o_stack.on_event_dialog = function (e) {
        console.log("on_event_dialog==========",e.i_code);
        var s_type = null;
        ...
        if(s_type === 'terminated'){
            CustomEvent.initCustomEvent("call-terminated", true, true, {});
            console.log("ready to dispatch event call-terminated");
